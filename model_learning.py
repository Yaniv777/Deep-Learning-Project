...
def model_training(train, val, test):
    ...
    data_dir = pathlib.Path(r"C:\Users\Student\OneDrive\Documents\Deep-Learning-Project-main\‏‏eyesDataset\Images")  # images dataset
    ...
    model.save(r"C:\Users\Student\OneDrive\Documents\Deep-Learning-Project-main\‏‏eyesDataset\Model\new_modell.h5")
