...
def make_test_folder():
    ...
    """
    working_dir = pathlib.Path(r'D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset')
...
def test_maker(image_count, test_split=0.2):
    ...
    working_dir = pathlib.Path(r"D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset\Images")  # images dataset path
    os.chdir(working_dir)
    random.seed(2)
    ...
    for photo in range(int(image_count * real_test_split)):
        ...
        shutil.move(closed_path + '\\' + random.choice(os.listdir(closed_path)),
                    r"D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset\Test\closed_look")
        ...
        shutil.move(open_path + '\\' + random.choice(os.listdir(open_path)),
                    r"D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset\Test\open_look")
...
def back_from_test(data_dir):
    ...
    closed_path = pathlib.Path(r"D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset\Images\closed_look")
    test_closed_path = data_dir + "/closed_look"
    test_closed_list = os.listdir(test_closed_path)  
    # closed eyes directory path
    open_path = pathlib.Path(r"D:\Users\yaniv\anaconda3\Projects\DL_Project_Eyes\‏‏eyesDataset\Images\open_look")
